                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post style-1" data-animation="fadeInUpBig" data-delay="'.$delay.'ms" data-duration="1000ms">
                                ...
                                <div class="blog-thumbnail bg-overlay">
                                  <a href="newsdetail.php?id='.$row['id'].';"  target=_blank;><img src="data:image/jpeg;base64,'.base64_encode($row['picture']).'"/> </a>
                                </div>
                            ...
                            echo '<div class="col-12 col-sm-6">
                                        <div class="single-blog-post d-flex style-4 mb-30">
                                            ...
                                            <div class="blog-content">
                                                <span class="post-date">'.get_timeago($row['timestamp']).'</span>
                                                <a href="newsdetail.php?id='.$row['id'].';"  target=_blank; class="post-title">'.$row['headline'].'</a>
                                                <a href="newsdetail.php?id='.$row['id'].';"  target=_blank; class="post-author">Source internet</a>
                                            </div>
                                        </div>
                                    </div>';
                        }
