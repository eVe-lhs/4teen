                            ...
                            echo '<div class="ml-2 ">
                                        <div class="single-blog-post style-2 mb-5 col-sm">
                                            ...
                                            <div class="blog-thumbnail">
                                                <a href="moviedetailLoggedIn.php?id='.$row['id'].'"  target=_blank;><img src="data:image/jpeg;base64,'.base64_encode($row['Poster']).'" /> </a>
                                            </div>
                                        </div>
                                    </div>';
                        }
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                            echo '<div class="ml-2">
                                        <div class="single-blog-post style-2 mb-5 col-sm">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="newsdetail.php?id='.$row['id'].';"  target=_blank;><img src="data:image/jpeg;base64,'.base64_encode($row['Poster']).'" onmouseover="fadeout(this)" onmouseout="appear(this)"/> </a>
                                            </div>
                                        </div>
                                    </div>';
                        }
