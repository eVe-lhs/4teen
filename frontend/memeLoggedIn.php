                  ...
                  <h1 class="memeheader">4teen Memes</h1>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav1">
                                ...
                                <form method="POST" class="justify-center ml-50 mb-30 border-bottom" enctype="multipart/form-data" action="addComment.php?name=<?= $_SESSION['name'] ?>">
   
   <label for="story" style="color: black;">Meme Caption:</label><br>
       <textarea name="story" style="height: 100px;" placeholder="Meme Caption" id="question" class="bg-black text-white"></textarea><br>
      <input type="file" name="meme" id="image" class="bg-black" required><br>
   <input type="submit" value="Upload" id="insert" name="meme" class="mt-2 btn btn-dark">
                                    <script>
