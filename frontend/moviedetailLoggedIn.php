            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm">
                    <div class="post-details-content mb-100 ">
                        <div class="row">
                         <img class="mb-30 col" src="data:image/jpeg;base64,<?= base64_encode($row['Poster']) ?>" alt="">
                        ...
                        <div class="contact-form-area">
                            <form action="addComment.php?id=<?=$id?>&name=<?= $_SESSION['name']?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button class="btn newsbox-btn mt-30" type="submit" name='commentMov'>Submit Comment</button>
                                    </div>
                                </div>
                            </form>
                        </div>
