...
if(isset($_GET['id'])){
    ...
    switch($row['catagory'])
    {
        case "celebrities":$bgcolor="#df678c";
                            $tagcolor="#3d155f";
            break;
        case "science":$bgcolor="#292826";
                            $tagcolor="#f9d342";
            break;
        case "entertainment":$bgcolor="#1d1b1c";
                            $tagcolor="#ec3d47";
            break;
        case "sport":$bgcolor="red";
                            $tagcolor="#d6ed17";
            break;
    }
}
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: <?= $tagcolor ?>;"><span><?= $row['catagory'] ?></span></p>
                        <p class="post-title"><?= $row['headline']  ?></p>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100 ">
                        <div style="width: 100%;">
                         <img class="mb-30" src="data:image/jpeg;base64,<?= base64_encode($row['picture']) ?>" alt="" width="100%"></div>
                        <p style="text-align: justify;"><?= $row['story'] ?></p>
                    </div>
                        ...
                        <ol>
                            <?php 
      $db=mysqli_connect("localhost","root","","quizes");
                            $sql="SELECT * FROM newscomments WHERE post_id=$id";
                    ...
                    <div class="post-a-comment-area mb-30 clearfix" style="color:black;">
                        <h4 class="mb-50">Leave a reply</h4>

                        <!-- Reply Form -->
                        <div class="contact-form-area">
                            <form action="addComment.php?id=<?=$id?>&name=<?= $_SESSION['name'] ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">
                                        <textarea name="message" class="form-control" id="message" cols="30" rows="10" placeholder="Message"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <button class="btn newsbox-btn mt-30" type="submit" name='comment'>Submit Comment</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget-area news-widget mb-30">
                            ...
                            <?php  $db=mysqli_connect("localhost","root","","quizes");
                                $sql="SELECT * FROM news ORDER by timestamp DESC LIMIT 6"; 
                                $result=mysqli_query($db,$sql);
                                while($row=mysqli_fetch_array($result))
                                {
                                    echo ' <!-- Single News Area -->
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="data:image/jpeg;base64,'.base64_encode($row['picture']).'" alt=""></a>
                                </div>

                                <!-- Blog Content -->
                                <div class="blog-content">
                                    <span class="post-date">'. date("M d, Y", strtotime($row['timestamp'])).'</span>
                                    <a href="newsdetail.php?id='.$row['id'].'" target=_blank class="post-title">'.$row['headline'].'</a>
                                </div>
                            </div>';
                                }
                            ?>
